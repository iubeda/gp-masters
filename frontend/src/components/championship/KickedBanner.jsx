  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 space-y-8 animate-fadeIn">
      ...
      >
        ...
        {t('championship.kicked.back_btn', 'VOLVER AL DASHBOARD')}
      </button>
      ...
      <div className="glass rounded-2xl border border-red-500/20 p-8 text-center space-y-6 bg-gradient-to-br from-red-950/20 to-transparent">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-extrabold text-white">{t('championship.kicked.title', 'Has sido expulsado de este campeonato')}</h2>
          <p className="text-gray-450 text-sm max-w-md mx-auto leading-relaxed">
            {t('championship.kicked.subtitle', 'Un organizador (Master o Admin) te ha retirado la participación activa de este torneo.')}
          </p>
        </div>
        {championship.kick_reason && (
          <div className="bg-[#0F0F12]/80 border border-red-500/10 p-5 rounded-2xl max-w-lg mx-auto text-left space-y-1">
            <span className="text-[10px] text-red-500 font-bold uppercase tracking-wider block">{t('championship.kicked.reason', 'Motivo especificado:')}</span>
