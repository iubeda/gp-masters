...
* **Visualización sin Participación**: No necesita registrar un equipo ni ocupar una plaza en la parrilla para acceder al "GP Activo" de un campeonato ni a sus salas de WebSockets. Al ingresar, visualiza una interfaz especial de **Modo Administrador** que le oculta las herramientas individuales pero le permite ver el estado general, forzar la simulación del Gran Premio y disfrutar del Live Timing en tiempo real.
